...
let mockChallenges: any[] = [
  { 
    ...
    category: 'Web', 
    points: 100, 
    description: 'Find the hidden admin credentials in the source.', 
    flag: 'VYUGAM{view_source_is_not_enough}', 
    solvesCount: 12,
    externalLink: 'https://vault.vyugam.live'
  },
  { 
    id: '2', 
  ...
  { 
    ...
    points: 300, 
    description: 'Convince the AI to reveal its secret flag.', 
    flag: 'VYUGAM{prompt_injection_success}', 
    solvesCount: 8 
  },
];
